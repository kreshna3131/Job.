              ...
              <div className="row">
                <div className="col-6">
                  ...
                  <div className="d-flex gap-3">
                    <div>
                      <p className="mb-0">Published at</p>
                      <p className="fs-5">{job.createdAt}</p>
                    </div>
                    <div>
                      <p className="mb-0">Published by</p>
                      <p className="fs-5">{job.User.email}</p>
                    </div>
                  </div>
                </div>
                <div className="col-6 text-end mt-auto mb-3">
                  <button className="btn btn-primary col-4">Apply Now</button>
                </div>
              </div>
            </div>
            <div className="card border-0 shadow p-5 my-3">
              <h5 className="">Basic Salary Offered </h5>
